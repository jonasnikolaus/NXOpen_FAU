...
def list_geometries():
    ...
    # Ein Set erstellen, um bereits verarbeitete Kanten zu speichern
    processed_edges = set()
    ...
    for body in workPart.Bodies:
        ...
        for face in body.GetFaces():
            ...
            for edge in edges:
                if edge not in processed_edges:  # Prüfen, ob die Kante bereits verarbeitet wurde
                    processed_edges.add(edge)  # Kante zum Set hinzufügen
